import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as t}from"./app-9a1db62f.js";const e={},p=t(`<p>In this article, I implement a very simple thread pool using threading package. Details see the code below.</p><h2 id="thread-implementation" tabindex="-1"><a class="header-anchor" href="#thread-implementation" aria-hidden="true">#</a> Thread implementation</h2><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> threading
